...
HierarchyModifier_lateinit : 'lateinit';
...
FunctionModifier_tailrec : 'tailrec';
FunctionModifier_operator : 'operator';
FunctionModifier_infix : 'infix';
FunctionModifier_inline : 'inline';
FunctionModifier_external : 'external';
PropertyModifier_const : 'const';
