...
public interface KotlinParserListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterKeywordOrSimpleName(KotlinParser.KeywordOrSimpleNameContext ctx);
	/**
	 * Exit a parse tree produced by {@link KotlinParser#keywordOrSimpleName}.
	 * @param ctx the parse tree
	 */
	void exitKeywordOrSimpleName(KotlinParser.KeywordOrSimpleNameContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterClassOrInterface(KotlinParser.ClassOrInterfaceContext ctx);
	/**
	 * Exit a parse tree produced by {@link KotlinParser#classOrInterface}.
	 * @param ctx the parse tree
	 */
	void exitClassOrInterface(KotlinParser.ClassOrInterfaceContext ctx);
	/**
