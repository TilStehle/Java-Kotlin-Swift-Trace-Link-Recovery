...
public interface KotlinParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link KotlinParser#keywordOrSimpleName}.
	 * @param ctx the parse tree
	 */
	void enterKeywordOrSimpleName(@NotNull KotlinParser.KeywordOrSimpleNameContext ctx);
	/**
	 * Exit a parse tree produced by {@link KotlinParser#keywordOrSimpleName}.
	 * @param ctx the parse tree
	 */
	void exitKeywordOrSimpleName(@NotNull KotlinParser.KeywordOrSimpleNameContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link KotlinParser#classOrInterface}.
	 * @param ctx the parse tree
	 */
	void enterClassOrInterface(@NotNull KotlinParser.ClassOrInterfaceContext ctx);
	/**
	 * Exit a parse tree produced by {@link KotlinParser#classOrInterface}.
	 * @param ctx the parse tree
	 */
	void exitClassOrInterface(@NotNull KotlinParser.ClassOrInterfaceContext ctx);
	/**
